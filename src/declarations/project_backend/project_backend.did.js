export const idlFactory = ({ IDL }) => {
  ...
  const Result_2 = IDL.Variant({ 'ok' : AnimalId, 'err' : IDL.Text });
  ...
  return IDL.Service({
    ...
    'mintBreedNFT' : IDL.Func([IDL.Text], [Result_3], []),
    ...
    'transferOwnership' : IDL.Func([AnimalId, IDL.Principal], [Result], []),
    'verifyAnimal' : IDL.Func([AnimalId], [Result], []),
    'verifyMicrochip' : IDL.Func([MicrochipId], [IDL.Opt(AnimalId)], ['query']),
    'verifyUser' : IDL.Func([], [Result], []),
  });
};
